    ...
    <div class="app-wrapper">
      ...
      <nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="indexmain.php" class="nav-link">Home</a></li>
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          <!--begin::Brand Link-->
          <a href="./indexmain.php" class="brand-link">
            <!--begin::Brand Image-->
            <img
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              <li class="nav-item">
                <a href="indexmain.php" class="nav-link active">
      ...
      <main class="app-main">
        ...
        <div class="app-content">
          ...
          <!--END OF CARDS FOR REQUEST STATISTICS-->
